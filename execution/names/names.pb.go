...
type Entry struct {
	...
	Owner github_com_klyed_hivesmartchain_crypto.Address `protobuf:"bytes,2,opt,name=Owner,proto3,customtype=github.com/klyed/hivesmartchain/crypto.Address" json:"Owner"`
