...
type Entry struct {
	...
	Owner github_com_hyperledger_burrow_crypto.Address `protobuf:"bytes,2,opt,name=Owner,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/crypto.Address" json:"Owner"`
