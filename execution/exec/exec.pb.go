...
func (m *TxHeader) GetTxType() github_com_klye-dev_hsc-main_txs_payload.Type {
	if m != nil {
		return m.TxType
	}
	return 0
...
func (m *Header) GetTxType() github_com_klye-dev_hsc-main_txs_payload.Type {
	if m != nil {
		return m.TxType
	}
	return 0
...
func (this *StreamEvent) SetValue(value interface{}) bool {
	...
	case *BeginTx:
		this.BeginTx = vt
	case *github_com_klye-dev_hsc-main_txs.Envelope:
		this.Envelope = vt
	case *Event:
		this.Event = vt
	case *EndTx:
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxType |= github_com_klye-dev_hsc-main_txs_payload.Type(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *LogEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			var v github_com_klye-dev_hsc-main_binary.Word256
