...
import (
	...
	errors "github.com/klyed/hivesmartchain/execution/errors"
	...
	github_com_klyed_hsc-main_txs "github.com/klyed/hivesmartchain/txs"
	txs "github.com/klyed/hivesmartchain/txs"
	github_com_klyed_hsc-main_txs_payload "github.com/klyed/hivesmartchain/txs/payload"
...
type StreamEvent struct {
	...
	Envelope             *github_com_klyed_hsc-main_txs.Envelope `protobuf:"bytes,3,opt,name=Envelope,proto3,customtype=github.com/klyed/hivesmartchain/txs.Envelope" json:"Envelope,omitempty"`
...
type EndTx struct {
	...
	TxHash               github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,3,opt,name=TxHash,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"TxHash"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}
...
type TxHeader struct {
	// Transaction type
	TxType github_com_klyed_hsc-main_txs_payload.Type `protobuf:"varint,1,opt,name=TxType,proto3,casttype=github.com/klyed/hivesmartchain/txs/payload.Type" json:"TxType,omitempty"`
	// The hash of the transaction that caused this event to be generated
	TxHash github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,2,opt,name=TxHash,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"TxHash"`
...
func (m *TxHeader) GetTxType() github_com_klyed_hsc-main_txs_payload.Type {
	if m != nil {
		return m.TxType
	}
	return 0
...
type TxExecution struct {
	*TxHeader `protobuf:"bytes,1,opt,name=Header,proto3,embedded=Header" json:"Header,omitempty"`
	...
	Envelope *github_com_klyed_hsc-main_txs.Envelope `protobuf:"bytes,6,opt,name=Envelope,proto3,customtype=github.com/klyed/hivesmartchain/txs.Envelope" json:"Envelope,omitempty"`
	// Execution events
...
func (m *Header) GetTxType() github_com_klyed_hsc-main_txs_payload.Type {
	if m != nil {
		return m.TxType
	}
	return 0
...
type LogEvent struct {
	...
	Data                 github_com_klyed_hsc-main_binary.HexBytes  `protobuf:"bytes,2,opt,name=Data,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"Data"`
	Topics               []github_com_klyed_hsc-main_binary.Word256 `protobuf:"bytes,3,rep,name=Topics,proto3,customtype=github.com/klyed/hivesmartchain/binary.Word256" json:"Topics"`
	XXX_NoUnkeyedLiteral struct{}                                       `json:"-"`
	XXX_unrecognized     []byte                                         `json:"-"`
	XXX_sizecache        int32                                          `json:"-"`
}
...
type CallEvent struct {
	...
	Origin               github_com_klyed_hsc-main_crypto.Address  `protobuf:"bytes,2,opt,name=Origin,proto3,customtype=github.com/klyed/hivesmartchain/crypto.Address" json:"Origin"`
	StackDepth           uint64                                        `protobuf:"varint,3,opt,name=StackDepth,proto3" json:"StackDepth,omitempty"`
	Return               github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,4,opt,name=Return,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"Return"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}
...
type CallData struct {
	Caller github_com_klyed_hsc-main_crypto.Address  `protobuf:"bytes,1,opt,name=Caller,proto3,customtype=github.com/klyed/hivesmartchain/crypto.Address" json:"Caller"`
	Callee github_com_klyed_hsc-main_crypto.Address  `protobuf:"bytes,2,opt,name=Callee,proto3,customtype=github.com/klyed/hivesmartchain/crypto.Address" json:"Callee"`
	Data   github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,3,opt,name=Data,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"Data"`
...
func (this *StreamEvent) SetValue(value interface{}) bool {
	...
	case *BeginTx:
		this.BeginTx = vt
	case *github_com_klyed_hsc-main_txs.Envelope:
		this.Envelope = vt
	case *Event:
		this.Event = vt
	case *EndTx:
...
func (m *StreamEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Envelope == nil {
				m.Envelope = &github_com_klyed_hsc-main_txs.Envelope{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxType |= github_com_klyed_hsc-main_txs_payload.Type(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *LogEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			var v github_com_klyed_hsc-main_binary.Word256
