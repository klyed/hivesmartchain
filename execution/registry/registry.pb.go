...
type NodeIdentity struct {
	...
	TendermintNodeID github_com_hyperledger_burrow_crypto.Address `protobuf:"bytes,3,opt,name=TendermintNodeID,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/crypto.Address" json:"TendermintNodeID"`
	...
	ValidatorPublicKey   *github_com_hyperledger_burrow_crypto.PublicKey `protobuf:"bytes,4,opt,name=ValidatorPublicKey,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/crypto.PublicKey" json:"ValidatorPublicKey,omitempty"`
