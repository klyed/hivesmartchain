...
type NodeIdentity struct {
	...
	TendermintNodeID github_com_klyed_hivesmartchain_crypto.Address `protobuf:"bytes,3,opt,name=TendermintNodeID,proto3,customtype=github.com/klyed/hivesmartchain/crypto.Address" json:"TendermintNodeID"`
...
func (m *NodeIdentity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			var v github_com_klyed_hivesmartchain_crypto.PublicKey
