...
type PermArgs struct {
	...
	Target *github_com_klye-dev_hsc-main_crypto.Address `protobuf:"bytes,2,opt,name=Target,customtype=github.com/klye-dev/hsc-main/crypto.Address" json:"Target,omitempty"`
	// Possible arguments
