...
type PermArgs struct {
	...
	Target *github_com_hyperledger_burrow_crypto.Address `protobuf:"bytes,2,opt,name=Target,customtype=github.com/KLYE-Dev/HSC-MAIN/crypto.Address" json:"Target,omitempty"`
	// Possible arguments
