...
type Account struct {
	...
	CodeHash github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,8,opt,name=CodeHash,proto3,customtype=github.com/klye-dev/hivesmartchain/binary.HexBytes" json:"-"`
	...
	Forebear             *github_com_klye-dev_hsc-main_crypto.Address `protobuf:"bytes,10,opt,name=Forebear,proto3,customtype=github.com/klye-dev/hivesmartchain/crypto.Address" json:"Forebear,omitempty"`
...
type ContractMeta struct {
	...
	MetadataHash github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,2,opt,name=MetadataHash,proto3,customtype=github.com/klye-dev/hivesmartchain/binary.HexBytes" json:"MetadataHash"`
