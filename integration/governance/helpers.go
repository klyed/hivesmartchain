...
func newConfig(genesisDoc *genesis.GenesisDoc, account *acm.PrivateAccount,
	keysAccounts ...*acm.PrivateAccount) (conf *config.BurrowTendermintConfig, err error) {
...
func newKernelAndBoot(conf *config.BurrowTendermintConfig, account *acm.PrivateAccount,
