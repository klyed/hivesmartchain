...
type GetMetadataParam struct {
	...
	MetadataHash         *github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,2,opt,name=MetadataHash,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/binary.HexBytes" json:"MetadataHash,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                       `json:"-"`
	XXX_unrecognized     []byte                                         `json:"-"`
	XXX_sizecache        int32                                          `json:"-"`
}
...
type GetStorageParam struct {
	Address              github_com_klye-dev_hsc-main_crypto.Address `protobuf:"bytes,1,opt,name=Address,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/crypto.Address" json:"Address"`
	Key                  github_com_klye-dev_hsc-main_binary.Word256 `protobuf:"bytes,2,opt,name=Key,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/binary.Word256" json:"Key"`
	XXX_NoUnkeyedLiteral struct{}                                     `json:"-"`
	XXX_unrecognized     []byte                                       `json:"-"`
	XXX_sizecache        int32                                        `json:"-"`
}
...
type StorageValue struct {
	Value                github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,1,opt,name=Value,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/binary.HexBytes" json:"Value"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}
