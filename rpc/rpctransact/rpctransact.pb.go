...
import (
	...
	_ "github.com/klyed/hivesmartchain/execution/exec"
	_ "github.com/klyed/hivesmartchain/txs"
...
type CallCodeParam struct {
	FromAddress          github_com_klyed_hsc-main_crypto.Address `protobuf:"bytes,1,opt,name=FromAddress,proto3,customtype=github.com/klyed/hivesmartchain/crypto.Address" json:"FromAddress"`
...
type TxEnvelope struct {
	Envelope             *github_com_klyed_hsc-main_txs.Envelope `protobuf:"bytes,1,opt,name=Envelope,proto3,customtype=github.com/klyed/hivesmartchain/txs.Envelope" json:"Envelope,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                    `json:"-"`
	XXX_unrecognized     []byte                                      `json:"-"`
	XXX_sizecache        int32                                       `json:"-"`
}
