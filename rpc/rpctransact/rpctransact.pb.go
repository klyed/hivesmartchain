...
import (
	...
	_ "github.com/klye-dev/hivesmartchain/execution/exec"
	_ "github.com/klye-dev/hivesmartchain/txs"
...
type CallCodeParam struct {
	FromAddress          github_com_klye-dev_hsc-main_crypto.Address `protobuf:"bytes,1,opt,name=FromAddress,proto3,customtype=github.com/klye-dev/hivesmartchain/crypto.Address" json:"FromAddress"`
...
type TxEnvelope struct {
	Envelope             *github_com_klye-dev_hsc-main_txs.Envelope `protobuf:"bytes,1,opt,name=Envelope,proto3,customtype=github.com/klye-dev/hivesmartchain/txs.Envelope" json:"Envelope,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                    `json:"-"`
	XXX_unrecognized     []byte                                      `json:"-"`
	XXX_sizecache        int32                                       `json:"-"`
}
...
func (m *TxEnvelope) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Envelope == nil {
				m.Envelope = &github_com_klye-dev_hsc-main_txs.Envelope{}
			}
