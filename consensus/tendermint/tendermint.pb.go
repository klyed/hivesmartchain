...
type NodeInfo struct {
	ID                   github_com_klyed_hsc-main_crypto.Address  `protobuf:"bytes,1,opt,name=ID,proto3,customtype=github.com/klyed/hivesmartchain/crypto.Address" json:"ID"`
	...
	Channels             github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,5,opt,name=Channels,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"Channels"`
