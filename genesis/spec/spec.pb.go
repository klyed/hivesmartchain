...
import (
	...
	github_com_klye-dev_hsc-main_acm "github.com/klye-dev/hivesmartchain/acm"
	balance "github.com/klye-dev/hivesmartchain/acm/balance"
...
type TemplateAccount struct {
	...
	Address          *github_com_klye-dev_hsc-main_crypto.Address `protobuf:"bytes,2,opt,name=Address,proto3,customtype=github.com/klye-dev/hivesmartchain/crypto.Address" json:",omitempty" toml:",omitempty"`
	...
	Code             *github_com_klye-dev_hsc-main_acm.Bytecode   `protobuf:"bytes,7,opt,name=Code,proto3,customtype=github.com/klye-dev/hivesmartchain/acm.Bytecode" json:"Code,omitempty"`
...
func (m *TemplateAccount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			var v github_com_klye-dev_hsc-main_acm.Bytecode
			m.Code = &v
