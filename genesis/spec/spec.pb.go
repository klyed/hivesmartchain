...
import (
	...
	github_com_klyed_hivesmartchain_acm "github.com/klyed/hivesmartchain/acm"
...
type TemplateAccount struct {
	...
	Address          *github_com_klyed_hivesmartchain_crypto.Address `protobuf:"bytes,2,opt,name=Address,proto3,customtype=github.com/klyed/hivesmartchain/crypto.Address" json:",omitempty" toml:",omitempty"`
...
func (m *TemplateAccount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			var v github_com_klyed_hivesmartchain_acm.Bytecode
			m.Code = &v
