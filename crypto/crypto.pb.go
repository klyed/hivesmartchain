...
type PublicKey struct {
	...
	PublicKey            github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,2,opt,name=PublicKey,proto3,customtype=github.com/klye-dev/hivesmartchain/binary.HexBytes" json:"PublicKey"`
