...
type PublicKey struct {
	...
	PublicKey            github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,2,opt,name=PublicKey,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"PublicKey"`
