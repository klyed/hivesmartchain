...
import (
	...
	registry "github.com/klye-dev/hivesmartchain/execution/registry"
...
type CallTx struct {
	...
	Address *github_com_klye-dev_hsc-main_crypto.Address `protobuf:"bytes,2,opt,name=Address,proto3,customtype=github.com/klye-dev/hivesmartchain/crypto.Address" json:"Address,omitempty"`
	...
	// EVM bytecode
	Data github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,5,opt,name=Data,proto3,customtype=github.com/klye-dev/hivesmartchain/binary.HexBytes" json:"Data"`
	// WASM bytecode
	WASM github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,6,opt,name=WASM,proto3,customtype=github.com/klye-dev/hivesmartchain/binary.HexBytes" json:"tags,omitempty"`
...
type ContractMeta struct {
	CodeHash             github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,1,opt,name=CodeHash,proto3,customtype=github.com/klye-dev/hivesmartchain/binary.HexBytes" json:"CodeHash"`
...
type ProposalTx struct {
	...
	ProposalHash         *github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,3,opt,name=ProposalHash,proto3,customtype=github.com/klye-dev/hivesmartchain/binary.HexBytes" json:"ProposalHash,omitempty"`
...
type Ballot struct {
	...
	FinalizingTx         *github_com_klye-dev_hsc-main_binary.HexBytes `protobuf:"bytes,2,opt,name=FinalizingTx,proto3,customtype=github.com/klye-dev/hivesmartchain/binary.HexBytes" json:"FinalizingTx,omitempty"`
