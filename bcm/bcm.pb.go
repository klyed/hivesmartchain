...
type SyncInfo struct {
	...
	LatestBlockHash   github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,2,opt,name=LatestBlockHash,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"LatestBlockHash"`
	LatestAppHash     github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,3,opt,name=LatestAppHash,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"LatestAppHash"`
...
type PersistedState struct {
	AppHashAfterLastBlock github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,1,opt,name=AppHashAfterLastBlock,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"AppHashAfterLastBlock"`
	...
	GenesisHash           github_com_klyed_hsc-main_binary.HexBytes `protobuf:"bytes,4,opt,name=GenesisHash,proto3,customtype=github.com/klyed/hivesmartchain/binary.HexBytes" json:"GenesisHash"`
	XXX_NoUnkeyedLiteral  struct{}                                      `json:"-"`
	XXX_unrecognized      []byte                                        `json:"-"`
	XXX_sizecache         int32                                         `json:"-"`
}
