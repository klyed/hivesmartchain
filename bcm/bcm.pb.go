...
type SyncInfo struct {
	...
	LatestBlockHash   github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,2,opt,name=LatestBlockHash,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/binary.HexBytes" json:"LatestBlockHash"`
	LatestAppHash     github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,3,opt,name=LatestAppHash,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/binary.HexBytes" json:"LatestAppHash"`
...
type PersistedState struct {
	AppHashAfterLastBlock github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,1,opt,name=AppHashAfterLastBlock,proto3,customtype=github.com/KLYE-Dev/HSC-MAIN/binary.HexBytes" json:"AppHashAfterLastBlock"`
