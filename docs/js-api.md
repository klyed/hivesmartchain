...
###### Returns
`TxExecution` - The return data object is a [TxExecution](https://github.com/klyed/hivesmartchain/blob/main/protobuf/exec.proto#L34-L56).
###### Example
...
###### Returns
`GetEventsResponse` - The return data object is a [GetEventsResponse](https://github.com/klyed/hivesmartchain/blob/main/protobuf/rpcevents.proto#L91-L94)
