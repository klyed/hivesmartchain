...
is in yaml format. The top level structure is an array of [jobs](https://github.com/klye-dev/hsc-main/blob/main/deploy/def/job.go).
The different job types are [defined here](https://github.com/klye-dev/hsc-main/blob/main/deploy/def/jobs.go).
