...
[execution context](https://github.com/klye-dev/hivesmartchain/tree/main/execution/contexts).

Our transactions are defined in Protobuf [here](https://github.com/klye-dev/hivesmartchain/blob/main/protobuf/payload.proto).
...
> A future revision will change the way in which leases are calculated. Currently we use a somewhat historically-rooted fixed fee, see the [`NameCostPerBlock` function](https://github.com/klye-dev/hivesmartchain/blob/main/execution/names/names.go#L83).
